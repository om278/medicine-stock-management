...
class Pharmacy:
    def __init__(self, root):
        self.root = root
        self.root.title("Medicines Stock Management")
        self.root.geometry("1350x800+0+0")
        self.root.resizable(False, False)
        self.root.iconbitmap(r"/Users/admin/Desktop/untitled folder/image/doc.ico")
        ...
        ######## title animation #########
        self.txt = "MEDICINES STOCK MANAGEMENT"
        self.count = 0
        self.text = ""
        self.color = ["green"]
        ...
        ######### pharmacy logo label #######
        img1 = Image.open(r"/Users/admin/Desktop/untitled folder/image\new.png")
        ...
        conn = sqlite3.connect(database=r'/Users/admin/Desktop/untitled folder/pharmacy.db')
        ...
        # image 1
        self.bg = ImageTk.PhotoImage(file=r"/Users/admin/Desktop/untitled folder/image/med.jpg")
        lbl_bg = Label(left_smallframe, image=self.bg)
        lbl_bg.place(x=370, y=165, width=200, height=150)
        # image 2
        self.bgg = ImageTk.PhotoImage(file=r"/Users/admin/Desktop/untitled folder/image/medi.jpg")
        ...
        # image 1
        self.bg1 = ImageTk.PhotoImage(file=r"C:/Users/admin/Desktop/untitled folder/image/co.jpg")
        lbl_bg1 = Label(right_frame, image=self.bg1)
        lbl_bg1.place(x=0, y=0, width=240, height=100)
        # image 2
        self.bg2 = ImageTk.PhotoImage(file=r"/Users/admin/Desktop/untitled folder/image/inject.jpg")
